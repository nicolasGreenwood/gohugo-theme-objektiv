...
Next, we'll click on "Import repository".

<img width="583" height="534" alt="Screenshot 2026-02-16 at 20 58 45" src="https://github.com/user-attachments/assets/82acac88-240c-493c-aa82-710ef11b1c34" />

You'll be taken to a new page where we can now input the information of the repo we need to clone.
